...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		addShip("vanguard_Strike", 7);
		addShip("vanguard_pirates_Attack", 3);
		addShip("manticore_Support", 7);
		addShip("manticore_pirates_Assault", 3);

		addShip("eradicator_Strike", 7);
		addShip("eradicator_pirates_Attack", 3);
